...
@Component("Project261_264FillImpl_Week")
public class Project261_264FillImpl_Week implements FillBasics{
	...
	public void fillData(XWPFDocument doc2,String pojoId,String time) {		
		...
		FillWordMapUtils.verticalDisplacement_Week(doc2,reportWeekDatas,"${tablea}","17",ReportConfig.WEEK_SEDIMENTATION_BANK);
